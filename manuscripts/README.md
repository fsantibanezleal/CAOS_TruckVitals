...
- **This version (v1.1):** [10.5281/zenodo.22016415](https://doi.org/10.5281/zenodo.22016415),
  record at <https://zenodo.org/records/22016415>, CC-BY-4.0, published 2026-08-19.
  v1.0 ([10.5281/zenodo.22002432](https://doi.org/10.5281/zenodo.22002432), 2026-08-18) remains
  available and is superseded: **v1.1 RETRACTS** the shape explanation v1.0 offered for its
  counter-example, after a preregistered test refuted it. Appendix B of the report carries the
  retraction, and the preregistration itself is in the management repo.
- **Source:** [`regime-conditioning-benchmark/tex/main.tex`](regime-conditioning-benchmark/tex/main.tex)
  (IEEEtran, 6 pp). Built PDF committed at
